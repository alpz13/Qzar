                    ...
                    if (errActividad) {
                        ...
                        actividadesAsignadas.sectoresPosibles(idModulo, function (errSectores, sectores) {
                            if (errSectores) {
                                ...
                                res.render('vermodulos', { titulo: 'Módulo ', modulo: modulos[0], usuario: req.session.usuario, barraLateral: 'modulos', alto: alto, ancho: ancho, cuadritos: cuadritos, actividades: actividades, sectores: sectores});
                            }
                        });
                    }
                });
